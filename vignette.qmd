...
We can further visualize this with these plots. Here we are using PC1 and PC2 which are the principle components explaining most of the variability.
```{r}
# PCA for plotting
...
For centers of each of the cluster means we can find each means